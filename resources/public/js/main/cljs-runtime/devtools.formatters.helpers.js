...
var G__31736 = devtools.prefs.pref(v);
v = G__31736;
continue;
} else {
return v;
...
}catch (e31713){var _e__28708__auto__ = e31713;
return false;
}})();
...
}catch (e31715){var _e__28708__auto__ = e31715;
return false;
}})();
...
}catch (e31717){var _e__28708__auto__ = e31717;
return false;
}}
}
});
...
var vec__31723 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31723,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31723,(1),null);
...
return cljs.core.some((function (p1__31726_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__31726_SHARP_);
}),template);
});
