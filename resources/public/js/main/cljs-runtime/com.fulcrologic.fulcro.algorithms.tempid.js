...
(com.fulcrologic.fulcro.algorithms.tempid.TempId.cljs$lang$ctorPrWriter = (function (this__5283__auto__,writer__5284__auto__,opt__5285__auto__){
return cljs.core._write(writer__5284__auto__,"com.fulcrologic.fulcro.algorithms.tempid/TempId");
}));
 ...
 */
com.fulcrologic.fulcro.algorithms.tempid.resolve_tempids_BANG_ = (function com$fulcrologic$fulcro$algorithms$tempid$resolve_tempids_BANG_(p__42818,tx_result){
var map__42820 = p__42818;
var map__42820__$1 = cljs.core.__destructure_map(map__42820);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42820__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42820__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var len__5722__auto___42850 = arguments.length;
var i__5723__auto___42851 = (0);
while(true){
if((i__5723__auto___42851 < len__5722__auto___42850)){
args_arr__5747__auto__.push((arguments[i__5723__auto___42851]));

var G__42852 = (i__5723__auto___42851 + (1));
i__5723__auto___42851 = G__42852;
continue;
} else {
}
break;
...
return com.fulcrologic.fulcro.algorithms.tempid.uuid.cljs$core$IFn$_invoke$arity$variadic(argseq__5748__auto__);
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.tempid.uuid.cljs$lang$applyTo = (function (seq42827){
var self__5708__auto__ = this;
return self__5708__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq42827));
}));
