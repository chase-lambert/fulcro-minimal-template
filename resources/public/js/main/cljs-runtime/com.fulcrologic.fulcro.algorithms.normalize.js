...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__49319){
var vec__49320 = p__49319;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49320,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49320,(1),null);
...
var data__$1 = (cljs.core.truth_((function (){var and__4996__auto__ = transform;
...
}),null)),null,172367347,null);
} else {
}

return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4((function (){var G__49331 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(query,cljs.core.first(ident));
var G__49332 = data__$1;
var G__49333 = tables;
var G__49334 = union_seen;
var G__49335 = transform;
return (com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5 ? com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5(G__49331,G__49332,G__49333,G__49334,G__49335) : com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.call(null,G__49331,G__49332,G__49333,G__49334,G__49335));
...
var vec__49392 = com.fulcrologic.fulcro.algorithms.do_not_use.join_entry(expr);
var join_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49392,(0),null);
var subquery = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49392,(1),null);
...
var G__49477 = cljs.core.next(q);
var G__49478 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,join_key,i);
q = G__49477;
ret = G__49478;
continue;
} else {
var G__49479 = cljs.core.next(q);
var G__49480 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,join_key,x);
q = G__49479;
ret = G__49480;
continue;
}
...
var xs = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (q,ret,vec__49392,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1){
return (function (p1__49325_SHARP_){
return (com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5 ? com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5(subquery__$1,p1__49325_SHARP_,tables,union_entry,transform) : com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.call(null,subquery__$1,p1__49325_SHARP_,tables,union_entry,transform));
});})(q,ret,vec__49392,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1))
),v);
if((!((((class$ == null)) || ((!(com.fulcrologic.fulcro.raw.components.has_ident_QMARK_(class$)))))))){
var is = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (q,ret,xs,vec__49392,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1){
return (function (p1__49326_SHARP_){
return com.fulcrologic.fulcro.raw.components.get_ident.cljs$core$IFn$_invoke$arity$2(class$,com.fulcrologic.fulcro.algorithms.normalize.hide_not_found(p1__49326_SHARP_));
});})(q,ret,xs,vec__49392,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1))
),xs);
if(cljs.core.vector_QMARK_(subquery__$1)){
if(cljs.core.empty_QMARK_(is)){
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(tables,((function (q,ret,is,xs,vec__49392,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1){
return (function (tables_SINGLEQUOTE_){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (q,ret,is,xs,vec__49392,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1){
return (function com$fulcrologic$fulcro$algorithms$normalize$normalize_STAR__$_merge_to_client_db(state,p__49400){
var vec__49401 = p__49400;
var ident = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49401,(0),null);
var entity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49401,(1),null);
return com.fulcrologic.fulcro.algorithms.normalize.upsert_ident(state,ident,entity);
});})(q,ret,is,xs,vec__49392,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1))
...
return (function (tables_SINGLEQUOTE_){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (q,ret,is,xs,vec__49392,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1){
return (function com$fulcrologic$fulcro$algorithms$normalize$normalize_STAR__$_merge_to_client_db(state,p__49411){
var vec__49412 = p__49411;
var ident = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49412,(0),null);
var entity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49412,(1),null);
return com.fulcrologic.fulcro.algorithms.normalize.upsert_ident(state,ident,entity);
});})(q,ret,is,xs,vec__49392,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1))
...
var G__49489 = cljs.core.next(q);
var G__49490 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,join_key,is);
q = G__49489;
ret = G__49490;
continue;
} else {
var G__49491 = cljs.core.next(q);
var G__49492 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,join_key,xs);
q = G__49491;
ret = G__49492;
continue;
}
...
if((v == null)){
var G__49493 = cljs.core.next(q);
var G__49494 = ret;
q = G__49493;
ret = G__49494;
continue;
} else {
var G__49495 = cljs.core.next(q);
var G__49496 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,join_key,v);
q = G__49495;
ret = G__49496;
continue;
...
if((v == null)){
var G__49497 = cljs.core.next(q);
var G__49498 = ret;
q = G__49497;
ret = G__49498;
continue;
} else {
var G__49499 = cljs.core.next(q);
var G__49500 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,v);
q = G__49499;
ret = G__49500;
continue;
}
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Normalize failed and no data will be inserted into the client DB. Error:",cljs.core.ex_message(e),(function (){var temp__5814__auto__ = (function (){var G__49422 = query;
var G__49422__$1 = (((G__49422 == null))?null:cljs.core.meta(G__49422));
var G__49422__$2 = (((G__49422__$1 == null))?null:new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(G__49422__$1));
if((G__49422__$2 == null)){
return null;
} else {
return com.fulcrologic.fulcro.raw.components.component_name(G__49422__$2);
}
})();
