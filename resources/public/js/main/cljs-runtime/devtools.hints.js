...
}catch (e28825){var _e = e28825;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5814__auto___28854 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5814__auto___28854)){
var seen_errors_28855 = temp__5814__auto___28854;
if(cljs.core.truth_(seen_errors_28855.has(self))){
} else {
seen_errors_28855.add(self);

var temp__5816__auto___28856 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5816__auto___28856)){
var sense_28857 = temp__5816__auto___28856;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_28857)].join(''));
} else {
}
}
} else {
