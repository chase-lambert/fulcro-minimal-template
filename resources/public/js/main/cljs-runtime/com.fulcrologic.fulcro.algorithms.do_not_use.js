...
var vec__45631 = ((cljs.core.seq_QMARK_(expr))?cljs.core.ffirst(expr):cljs.core.first(expr));
...
var expr__$1 = (function (){var G__45639 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__45639);
} else {
return G__45639;
}
})();
...
if(cljs.core.seq_QMARK_(expr)){
var G__45646 = cljs.core.first(expr);
return (com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1(G__45646) : com.fulcrologic.fulcro.algorithms.do_not_use.join_key.call(null,G__45646));
} else {
return expr;
...
var len__5722__auto___45697 = arguments.length;
var i__5723__auto___45698 = (0);
while(true){
if((i__5723__auto___45698 < len__5722__auto___45697)){
args__5728__auto__.push((arguments[i__5723__auto___45698]));

var G__45699 = (i__5723__auto___45698 + (1));
i__5723__auto___45698 = G__45699;
continue;
} else {
}
break;
...
return com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$core$IFn$_invoke$arity$variadic(argseq__5729__auto__);
});
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$lang$applyTo = (function (seq45652){
var self__5708__auto__ = this;
return self__5708__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45652));
}));
...
if(cljs.core.truth_((function (){var and__4996__auto__ = (s instanceof cljs.core.Keyword);
...
var and__4996__auto____$1 = query;
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["The composed root query is not valid EQL. The app may crash. See `(comp/get-query ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__45693 = query;
var G__45693__$1 = (((G__45693 == null))?null:cljs.core.meta(G__45693));
var G__45693__$2 = (((G__45693__$1 == null))?null:new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(G__45693__$1));
if((G__45693__$2 == null)){
return null;
} else {
return (component_name_fn.cljs$core$IFn$_invoke$arity$1 ? component_name_fn.cljs$core$IFn$_invoke$arity$1(G__45693__$2) : component_name_fn.call(null,G__45693__$2));
}
})()),")`"].join(''),query], null);
}),null)),null,-933800726,null);
} else {
}
