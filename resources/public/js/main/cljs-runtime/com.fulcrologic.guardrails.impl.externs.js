...
com.fulcrologic.guardrails.impl.externs.record_defn_BANG_ = (function com$fulcrologic$guardrails$impl$externs$record_defn_BANG_(NS,p__39519,externs){
var map__39521 = p__39519;
var map__39521__$1 = cljs.core.__destructure_map(map__39521);
var function$ = map__39521__$1;
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39521__$1,new cljs.core.Keyword("com.fulcrologic.guardrails.registry","fn-name","com.fulcrologic.guardrails.registry/fn-name",-1837692103));
...
com.fulcrologic.guardrails.impl.externs.register_external_function_BANG_ = (function com$fulcrologic$guardrails$impl$externs$register_external_function_BANG_(p__39525){
var map__39526 = p__39525;
var map__39526__$1 = cljs.core.__destructure_map(map__39526);
var external_function = map__39526__$1;
var var_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39526__$1,new cljs.core.Keyword("com.fulcrologic.guardrails.registry","var-name","com.fulcrologic.guardrails.registry/var-name",502701799));
...
var or__4998__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(com.fulcrologic.guardrails.impl.externs.external_function_registry),qualified_symbol);
...
var map__39527 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(info,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("com.fulcrologic.guardrails.registry","arities","com.fulcrologic.guardrails.registry/arities",1446074922),((has_arity_QMARK_)?arity:new cljs.core.Keyword(null,"n","n",562130025)),new cljs.core.Keyword("com.fulcrologic.guardrails.registry","gspec","com.fulcrologic.guardrails.registry/gspec",207045467),new cljs.core.Keyword("com.fulcrologic.guardrails.registry","metadata","com.fulcrologic.guardrails.registry/metadata",-1389979282)], null));
var map__39527__$1 = cljs.core.__destructure_map(map__39527);
var pure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39527__$1,new cljs.core.Keyword(null,"pure","pure",1433370394));
var pure_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39527__$1,new cljs.core.Keyword(null,"pure?","pure?",350862691));
var or__4998__auto__ = pure;
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
return pure_QMARK_;
...
var map__39528 = com.fulcrologic.guardrails.impl.externs.function_info(qualified_symbol);
var map__39528__$1 = cljs.core.__destructure_map(map__39528);
var info = map__39528__$1;
var spec_system = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39528__$1,new cljs.core.Keyword("com.fulcrologic.guardrails.registry","spec-system","com.fulcrologic.guardrails.registry/spec-system",-484591590));
if(cljs.core.truth_(info)){
var or__4998__auto__ = spec_system;
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
