...
var id = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54589_SHARP_){
return cljs.core.re_matches(/^#.*/,p1__54589_SHARP_);
}),tokens));
var classes = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54590_SHARP_){
return cljs.core.re_matches(/^\..*/,p1__54590_SHARP_);
}),tokens);
...
var G__54594 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(com.fulcrologic.fulcro.dom_common.remove_separators,classes))], null);
if(cljs.core.truth_(sanitized_id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54594,new cljs.core.Keyword(null,"id","id",-1388402092),sanitized_id);
} else {
return G__54594;
}
} else {
...
var map__54597 = com.fulcrologic.fulcro.dom_common.parse(kw);
var map__54597__$1 = cljs.core.__destructure_map(map__54597);
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__54597__$1,new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.PersistentVector.EMPTY);
...
var G__54608 = (function (){var or__4998__auto__ = props;
...
var G__54608__$1 = ((cljs.core.seq(classes))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54608,new cljs.core.Keyword(null,"className","className",-1983287057),com.fulcrologic.fulcro.dom_common.combined_classes(classes,existing_classes)):G__54608);
if(cljs.core.truth_(id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54608__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__54608__$1;
}
}
...
var strcls = (function (){var or__4998__auto__ = new cljs.core.Keyword(null,"className","className",-1983287057).cljs$core$IFn$_invoke$arity$1(props);
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
return "";
