...
var or__4998__auto__ = document.getElementById(id);
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
var G__47223 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__47223,"id",id);

goog.dom.appendChild(document.body,G__47223);
...
var G__47224 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__47224,"id",id);

goog.dom.appendChild(document.body,G__47224);
...
var temp__5814__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__47225_SHARP_){
return ((clojure.string.starts_with_QMARK_(p1__47225_SHARP_,"__reactInternalInstance$")) || (clojure.string.starts_with_QMARK_(p1__47225_SHARP_,"__reactFiber$")));
}),com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.getKeys(node)));
if(cljs.core.truth_(temp__5814__auto__)){
var instance_key = temp__5814__auto__;
...
var temp__5814__auto__ = com.fulcrologic.fulcro.inspect.element_picker.react_raw_instance(node);
if(cljs.core.truth_(temp__5814__auto__)){
var raw = temp__5814__auto__;
var instance = (function (){var or__4998__auto__ = com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.getValueByKeys(raw,"_currentElement","_owner","_instance");
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
...
com.fulcrologic.fulcro.inspect.element_picker.pick_element = (function com$fulcrologic$fulcro$inspect$element_picker$pick_element(p__47226){
var map__47227 = p__47226;
var map__47227__$1 = cljs.core.__destructure_map(map__47227);
var on_pick = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__47227__$1,new cljs.core.Keyword(null,"on-pick","on-pick",-1995648316),cljs.core.identity);
...
var instance = (function (){var G__47228 = target__$1;
if((G__47228 == null)){
return null;
} else {
return com.fulcrologic.fulcro.inspect.element_picker.react_instance(G__47228);
}
})();
...
var G__47241 = goog.dom.getParentElement(target__$1);
target__$1 = G__47241;
continue;
}
} else {
...
var G__47229_47242 = cljs.core.deref(current);
(on_pick.cljs$core$IFn$_invoke$arity$1 ? on_pick.cljs$core$IFn$_invoke$arity$1(G__47229_47242) : on_pick.call(null,G__47229_47242));
...
var state_map = (function (){var G__47230 = com.fulcrologic.fulcro.components.any__GT_app(comp);
var G__47230__$1 = (((G__47230 == null))?null:new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366).cljs$core$IFn$_invoke$arity$1(G__47230));
if((G__47230__$1 == null)){
return null;
} else {
return cljs.core.deref(G__47230__$1);
}
})();
...
}catch (e47231){var _ = e47231;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","static-query","fulcro.inspect.ui.element/static-query",1120589305),(function (){try{var G__47233 = comp;
var G__47233__$1 = (((G__47233 == null))?null:com.fulcrologic.fulcro.components.react_type(G__47233));
if((G__47233__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$1(G__47233__$1);
}
}catch (e47232){var _ = e47232;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","query","fulcro.inspect.ui.element/query",113020567),(function (){try{var G__47235 = comp;
var G__47235__$1 = (((G__47235 == null))?null:com.fulcrologic.fulcro.components.react_type(G__47235));
if((G__47235__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$2(G__47235__$1,state_map);
}
...
var app_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47236__$1,new cljs.core.Keyword("fulcro.inspect.core","app-uuid","fulcro.inspect.core/app-uuid",-1096445491));
