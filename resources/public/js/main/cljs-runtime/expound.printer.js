...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41603_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__41603_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41606_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__41606_SHARP_)));
}),row));
});
...
var G__41614 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__41615 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__41614,G__41615) : expound.printer.format.call(null,G__41614,G__41615));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41620_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__41620_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41621_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__41621_SHARP_)).length),"="));
}),header);
...
var iter__5476__auto__ = (function expound$printer$multirow_$_iter__41625(s__41626){
return (new cljs.core.LazySeq(null,(function (){
var s__41626__$1 = s__41626;
while(true){
var temp__5816__auto__ = cljs.core.seq(s__41626__$1);
if(temp__5816__auto__){
var s__41626__$2 = temp__5816__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41626__$2)){
var c__5474__auto__ = cljs.core.chunk_first(s__41626__$2);
var size__5475__auto__ = cljs.core.count(c__5474__auto__);
var b__41628 = cljs.core.chunk_buffer(size__5475__auto__);
if((function (){var i__41627 = (0);
while(true){
if((i__41627 < size__5475__auto__)){
var row_idx = cljs.core._nth(c__5474__auto__,i__41627);
cljs.core.chunk_append(b__41628,(function (){var iter__5476__auto__ = ((function (i__41627,row_idx,c__5474__auto__,size__5475__auto__,b__41628,s__41626__$2,temp__5816__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__41625_$_iter__41655(s__41656){
return (new cljs.core.LazySeq(null,((function (i__41627,row_idx,c__5474__auto__,size__5475__auto__,b__41628,s__41626__$2,temp__5816__auto__,split_row_contents){
return (function (){
var s__41656__$1 = s__41656;
while(true){
var temp__5816__auto____$1 = cljs.core.seq(s__41656__$1);
if(temp__5816__auto____$1){
var s__41656__$2 = temp__5816__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__41656__$2)){
var c__5474__auto____$1 = cljs.core.chunk_first(s__41656__$2);
var size__5475__auto____$1 = cljs.core.count(c__5474__auto____$1);
var b__41658 = cljs.core.chunk_buffer(size__5475__auto____$1);
if((function (){var i__41657 = (0);
while(true){
if((i__41657 < size__5475__auto____$1)){
var col_idx = cljs.core._nth(c__5474__auto____$1,i__41657);
cljs.core.chunk_append(b__41658,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__42464 = (i__41657 + (1));
i__41657 = G__42464;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41658),expound$printer$multirow_$_iter__41625_$_iter__41655(cljs.core.chunk_rest(s__41656__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41658),null);
}
} else {
var col_idx = cljs.core.first(s__41656__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__41625_$_iter__41655(cljs.core.rest(s__41656__$2)));
}
} else {
return null;
}
...
});})(i__41627,row_idx,c__5474__auto__,size__5475__auto__,b__41628,s__41626__$2,temp__5816__auto__,split_row_contents))
,null,null));
});})(i__41627,row_idx,c__5474__auto__,size__5475__auto__,b__41628,s__41626__$2,temp__5816__auto__,split_row_contents))
;
return iter__5476__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})());

var G__42466 = (i__41627 + (1));
i__41627 = G__42466;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41628),expound$printer$multirow_$_iter__41625(cljs.core.chunk_rest(s__41626__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41628),null);
}
} else {
var row_idx = cljs.core.first(s__41626__$2);
return cljs.core.cons((function (){var iter__5476__auto__ = ((function (row_idx,s__41626__$2,temp__5816__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__41625_$_iter__42178(s__42179){
return (new cljs.core.LazySeq(null,(function (){
var s__42179__$1 = s__42179;
while(true){
var temp__5816__auto____$1 = cljs.core.seq(s__42179__$1);
if(temp__5816__auto____$1){
var s__42179__$2 = temp__5816__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__42179__$2)){
var c__5474__auto__ = cljs.core.chunk_first(s__42179__$2);
var size__5475__auto__ = cljs.core.count(c__5474__auto__);
var b__42181 = cljs.core.chunk_buffer(size__5475__auto__);
if((function (){var i__42180 = (0);
while(true){
if((i__42180 < size__5475__auto__)){
var col_idx = cljs.core._nth(c__5474__auto__,i__42180);
cljs.core.chunk_append(b__42181,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__42467 = (i__42180 + (1));
i__42180 = G__42467;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42181),expound$printer$multirow_$_iter__41625_$_iter__42178(cljs.core.chunk_rest(s__42179__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42181),null);
}
} else {
var col_idx = cljs.core.first(s__42179__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__41625_$_iter__42178(cljs.core.rest(s__42179__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__41626__$2,temp__5816__auto__,split_row_contents))
;
return iter__5476__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__41625(cljs.core.rest(s__41626__$2)));
}
} else {
return null;
}
...
return iter__5476__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(row_height));
});
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42211_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__42211_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__42251 = via;
var G__42251__$1 = (((G__42251 == null))?null:cljs.core.last(G__42251));
if((G__42251__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__42251__$1);
}
})();
var keys_specs = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__42246_SHARP_){
return cljs.spec.alpha.valid_QMARK_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__42246_SHARP_);
...
}),cljs.core.tree_seq(cljs.core.coll_QMARK_,cljs.core.seq,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"clauses","clauses",1454841241),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42247_SHARP_){
return cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__42247_SHARP_);
}),keys_specs)], 0))], 0))))));
}
});
expound.printer.key__GT_spec = (function expound$printer$key__GT_spec(keys,problems){
var seq__42283_42532 = cljs.core.seq(problems);
var chunk__42284_42533 = null;
var count__42285_42534 = (0);
var i__42286_42535 = (0);
while(true){
if((i__42286_42535 < count__42285_42534)){
var p_42538 = chunk__42284_42533.cljs$core$IIndexed$_nth$arity$2(null,i__42286_42535);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_42538) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__42539 = seq__42283_42532;
var G__42540 = chunk__42284_42533;
var G__42541 = count__42285_42534;
var G__42542 = (i__42286_42535 + (1));
seq__42283_42532 = G__42539;
chunk__42284_42533 = G__42540;
count__42285_42534 = G__42541;
i__42286_42535 = G__42542;
continue;
} else {
var temp__5816__auto___42543 = cljs.core.seq(seq__42283_42532);
if(temp__5816__auto___42543){
var seq__42283_42544__$1 = temp__5816__auto___42543;
if(cljs.core.chunked_seq_QMARK_(seq__42283_42544__$1)){
var c__5521__auto___42545 = cljs.core.chunk_first(seq__42283_42544__$1);
var G__42546 = cljs.core.chunk_rest(seq__42283_42544__$1);
var G__42547 = c__5521__auto___42545;
var G__42548 = cljs.core.count(c__5521__auto___42545);
var G__42549 = (0);
seq__42283_42532 = G__42546;
chunk__42284_42533 = G__42547;
count__42285_42534 = G__42548;
i__42286_42535 = G__42549;
continue;
} else {
var p_42550 = cljs.core.first(seq__42283_42544__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_42550) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__42551 = cljs.core.next(seq__42283_42544__$1);
var G__42552 = null;
var G__42553 = (0);
var G__42554 = (0);
seq__42283_42532 = G__42551;
chunk__42284_42533 = G__42552;
count__42285_42534 = G__42553;
i__42286_42535 = G__42554;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__4998__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__42282_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__42282_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__42300){
var vec__42301 = p__42300;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42301,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42301,(1),null);
var G__42304 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42304__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__42308 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42308,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42308,(1),null);
var G__42312 = branch;
...
var len__5722__auto___42563 = arguments.length;
var i__5723__auto___42564 = (0);
while(true){
if((i__5723__auto___42564 < len__5722__auto___42563)){
args__5728__auto__.push((arguments[i__5723__auto___42564]));

var G__42566 = (i__5723__auto___42564 + (1));
i__5723__auto___42564 = G__42566;
continue;
} else {
}
break;
...
return expound.printer.format.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5729__auto__);
});
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq42318){
var G__42319 = cljs.core.first(seq42318);
var seq42318__$1 = cljs.core.next(seq42318);
var self__5707__auto__ = this;
return self__5707__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42319,seq42318__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42359_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__42359_SHARP_));
}),problems));
if(cljs.core.truth_((function (){var and__4996__auto__ = cljs.core.empty_QMARK_(new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(cljs.core.first(problems)));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__42360_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__42360_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__42366){
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42374_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__42374_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__42386 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
...
var line = first__42388;
var lines = seq__42387__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42380_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__42380_SHARP_)].join('');
}),lines)));
}));
...
var k = first__42394;
var rst = seq__42393__$1;
var rst__$1 = (function (){var or__4998__auto__ = rst;
if(or__4998__auto__){
return or__4998__auto__;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__42395 = show_valid_values_QMARK_;
var G__42396 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__42397 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__42395,G__42396,G__42397) : expound.printer.summary_form.call(null,G__42395,G__42396,G__42397));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__42592 = show_valid_values_QMARK_;
var G__42593 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__42594 = rst__$1;
show_valid_values_QMARK_ = G__42592;
form = G__42593;
in$ = G__42594;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__42398 = show_valid_values_QMARK_;
var G__42399 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__42400 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__42398,G__42399,G__42400) : expound.printer.summary_form.call(null,G__42398,G__42399,G__42400));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__42401 = show_valid_values_QMARK_;
var G__42402 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__42403 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__42401,G__42402,G__42403) : expound.printer.summary_form.call(null,G__42401,G__42402,G__42403));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__42404 = show_valid_values_QMARK_;
var G__42405 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__42406 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__42404,G__42405,G__42406) : expound.printer.summary_form.call(null,G__42404,G__42405,G__42406));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__42407 = show_valid_values_QMARK_;
var G__42408 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__42409 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__42407,G__42408,G__42409) : expound.printer.summary_form.call(null,G__42407,G__42408,G__42409));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42410_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__42410_SHARP_)).length);
...
var map__42411 = problem;
var map__42411__$1 = cljs.core.__destructure_map(map__42411);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42411__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42411__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__42412 = opts;
var map__42412__$1 = cljs.core.__destructure_map(map__42412);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__42412__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__42416 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__42417 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__42417);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__42416);
}})();
var vec__42413 = cljs.core.re_find(regex,s);
