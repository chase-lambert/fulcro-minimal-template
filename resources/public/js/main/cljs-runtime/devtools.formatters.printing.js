...
var len__5722__auto___31816 = arguments.length;
var i__5723__auto___31817 = (0);
while(true){
if((i__5723__auto___31817 < len__5722__auto___31816)){
args__5728__auto__.push((arguments[i__5723__auto___31817]));

var G__31818 = (i__5723__auto___31817 + (1));
i__5723__auto___31817 = G__31818;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31784){
...
return self__5707__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31785,G__31786,seq31784__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31787_SHARP_){
return (!((cljs.core.meta(p1__31787_SHARP_) == null)));
})))){
...
var map__31788 = opts;
var map__31788__$1 = cljs.core.__destructure_map(map__31788);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31788__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31789){var _e__28708__auto__ = e31789;
return false;
}})();
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
...
}catch (e31791){var _e__28708__auto__ = e31791;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__31793 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__31794 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__31794);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31795__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__31793);
}});
...
var temp__5814__auto___31820 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5814__auto___31820)){
var managed_print_level_31821 = temp__5814__auto___31820;
var _STAR_print_level_STAR__orig_val__31797_31822 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__31798_31823 = managed_print_level_31821;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__31798_31823);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__31796_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__31796_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__31797_31822);
}} else {
job_fn();
}
