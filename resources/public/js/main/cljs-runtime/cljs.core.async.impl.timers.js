...
var i_41036 = (self__.level + (1));
while(true){
if((i_41036 <= (new_level + (1)))){
(update[i_41036] = self__.header);

var G__41037 = (i_41036 + (1));
i_41036 = G__41037;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_41072 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_41072[i]));
} else {
x__$2.forward.push((((i < links_41072.length))?(links_41072[i]):null));
}

if((i < links_41072.length)){
(links_41072[i] = x__$2);
} else {
links_41072.push(x__$2);
}
...
var i_41074 = (0);
while(true){
if((i_41074 <= self__.level)){
var links_41075 = (update[i_41074]).forward;
if((x__$1 === (((i_41074 < links_41075.length))?(links_41075[i_41074]):null))){
(links_41075[i_41074] = (x__$1.forward[i_41074]));

var G__41079 = (i_41074 + (1));
i_41074 = G__41079;
continue;
} else {
var G__41080 = (i_41074 + (1));
i_41074 = G__41080;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__41096 = nx;
var G__41097 = (level__$1 - (1));
x = G__41096;
level__$1 = G__41097;
continue;
} else {
var G__41098 = x;
var G__41099 = (level__$1 - (1));
x = G__41098;
level__$1 = G__41099;
continue;
}
