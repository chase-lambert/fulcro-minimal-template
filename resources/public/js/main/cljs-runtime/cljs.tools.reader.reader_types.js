...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_32826 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_32826(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_32827 = (function (reader){
var x__5346__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_32827(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_32828 = (function (reader,ch){
var x__5346__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_32828(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_32829 = (function (reader){
var x__5346__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_32829(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_32833 = (function (reader){
var x__5346__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_32833(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_32834 = (function (reader){
var x__5346__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_32834(reader);
}
});
...
var G__32852 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__32853 = s.append(c);
c = G__32852;
s = G__32853;
continue;
}
