 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__45635){
var vec__45636 = p__45635;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45636,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45636,(1),null);
var ref = vec__45636;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__45640){
var vec__45642 = p__45640;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45642,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45642,(1),null);
var ref = vec__45642;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__45649){
var map__45650 = p__45649;
var map__45650__$1 = cljs.core.__destructure_map(map__45650);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45650__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
var temp__5814__auto__ = (function (){var and__4996__auto__ = cljs.core.coll_QMARK_(entity);
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__45658,entity,state_map,parent_node,idents_seen){
var map__45659 = p__45658;
var map__45659__$1 = cljs.core.__destructure_map(map__45659);
var join_node = map__45659__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45659__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45659__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
if(cljs.core.truth_((function (){var and__4996__auto__ = recursive_QMARK_;
if(and__4996__auto__){
return join_entity;
} else {
return and__4996__auto__;
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__45704,entity,state_map,idents_seen){
var map__45705 = p__45704;
var map__45705__$1 = cljs.core.__destructure_map(map__45705);
var join_node = map__45705__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45705__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__45710){
var map__45711 = p__45710;
var map__45711__$1 = cljs.core.__destructure_map(map__45711);
var node = map__45711__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45711__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var temp__5814__auto__ = (function (){var and__4996__auto__ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(lookup_ref);
if(and__4996__auto__){
...
var vec__45715 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45715,(0),null);
...
if(cljs.core.truth_(temp__5814__auto__)){
var e = temp__5814__auto__;
var temp__5814__auto____$1 = (function (){var G__45719 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__45719) : union_key__GT_query.call(null,G__45719));
})();
if(cljs.core.truth_(temp__5814__auto____$1)){
var target_ast_node = temp__5814__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__45721,current_entity,state_map,idents_seen){
var map__45722 = p__45721;
var map__45722__$1 = cljs.core.__destructure_map(map__45722);
var top_node = map__45722__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45722__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45722__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
var wildcard_QMARK_ = (function (){var and__4996__auto__ = nil_nodes;
if(cljs.core.truth_(and__4996__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__45727 = nil_nodes;
var G__45727__$1 = (((G__45727 == null))?null:cljs.core.first(G__45727));
if((G__45727__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__45727__$1);
}
})());
} else {
return and__4996__auto__;
...
var G__45728 = result_node__$1;
var G__45728__$1 = (((G__45728 == null))?null:cljs.core.persistent_BANG_(G__45728));
if((G__45728__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__45728__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var _STAR_denormalize_time_STAR__orig_val__45729 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_;
var _STAR_denormalize_time_STAR__temp_val__45730 = com.fulcrologic.fulcro.algorithms.denormalize.current_time();
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__temp_val__45730);

try{var ast = edn_query_language.core.query__GT_ast(query);
var G__45731 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__45731 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__45731,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__orig_val__45729);
}});
/**
...
var G__45733 = props;
var G__45733__$1 = (((G__45733 == null))?null:cljs.core.meta(G__45733));
if((G__45733__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__45733__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__45734 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__45735 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__45735);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__45734);
}});
/**
...
var map__45743 = cljs.core.meta(prior_props);
var map__45743__$1 = cljs.core.__destructure_map(map__45743);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45743__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45743__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));
