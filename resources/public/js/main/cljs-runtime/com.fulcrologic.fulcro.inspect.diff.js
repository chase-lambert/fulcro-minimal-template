...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (adds,p__39139){
var vec__39140 = p__39139;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39140,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39140,(1),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (rems,p__39143){
...
var temp__5814__auto__ = cljs.core.find(b,k);
if(cljs.core.truth_(temp__5814__auto__)){
var vec__39147 = temp__5814__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39147,(0),null);
var vb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39147,(1),null);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(rems,(function (){var G__39150 = k;
if(cljs.core.map_QMARK_(k)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39150,new cljs.core.Keyword("fulcro.inspect.lib.diff","key?","fulcro.inspect.lib.diff/key?",325118813),true);
} else {
return G__39150;
}
})());
...
com.fulcrologic.fulcro.inspect.diff.patch_updates = (function com$fulcrologic$fulcro$inspect$diff$patch_updates(x,p__39153){
var map__39154 = p__39153;
var map__39154__$1 = cljs.core.__destructure_map(map__39154);
var updates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39154__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","updates","fulcro.inspect.lib.diff/updates",221795125));
...
com.fulcrologic.fulcro.inspect.diff.patch_removals = (function com$fulcrologic$fulcro$inspect$diff$patch_removals(x,p__39156){
var map__39157 = p__39156;
var map__39157__$1 = cljs.core.__destructure_map(map__39157);
var removals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39157__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439));
...
var vec__39159 = cljs.core.first(rem);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(final$,k,(function (p1__39155_SHARP_){
var G__39162 = p1__39155_SHARP_;
var G__39163 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439),v], null);
return (com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2(G__39162,G__39163) : com.fulcrologic.fulcro.inspect.diff.patch_removals.call(null,G__39162,G__39163));
}));
} else {
