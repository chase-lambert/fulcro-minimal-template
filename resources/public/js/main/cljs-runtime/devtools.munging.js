...
var o31624 = temp__5814__auto__;
var temp__5814__auto____$1 = (o31624["core"]);
if(cljs.core.truth_(temp__5814__auto____$1)){
var o31625 = temp__5814__auto____$1;
return (o31625["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28701__auto__ = f;
return (o__28701__auto__["toString"]).call(o__28701__auto__);
} else {
return "";
}
}catch (e31626){var _ = e31626;
return "";
}});
...
try{var o__28701__auto___31704 = t;
(o__28701__auto___31704["cljs$lang$ctorPrWriter"]).call(o__28701__auto___31704,t,writer);
}catch (e31627){var __31705 = e31627;
}
...
var char_code = (function (){var o__28701__auto__ = (new String(char$));
return (o__28701__auto__["charCodeAt"]).call(o__28701__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28701__auto__ = String;
return (o__28701__auto__["fromCharCode"]).call(o__28701__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__31628 = num_code;
switch (G__31628) {
case (1):
return (185);
...
var o__28701__auto__ = String;
return (o__28701__auto__["fromCharCode"]).call(o__28701__auto__,superscript_code);
});
/**
...
}catch (e31629){var _e__28708__auto__ = e31629;
return false;
}})())){
...
var vec__31630 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31630,(0),null);
...
var or__4998__auto__ = (function (){var temp__5814__auto__ = cljs.core.re_matches(/(.*)\$/,s);
if(cljs.core.truth_(temp__5814__auto__)){
...
var len__5722__auto___31707 = arguments.length;
var i__5723__auto___31708 = (0);
while(true){
if((i__5723__auto___31708 < len__5722__auto___31707)){
args__5728__auto__.push((arguments[i__5723__auto___31708]));

var G__31709 = (i__5723__auto___31708 + (1));
i__5723__auto___31708 = G__31709;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__31635){
var vec__31636 = p__31635;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31636,(0),null);
...
var G__31710 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__31711 = cljs.core.butlast(remaining_tokens);
name_tokens = G__31710;
remaining_tokens = G__31711;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq31633){
var G__31634 = cljs.core.first(seq31633);
var seq31633__$1 = cljs.core.next(seq31633);
var self__5707__auto__ = this;
return self__5707__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31634,seq31633__$1);
}));
...
var vec__31641 = cljs.core.split_with((function (p1__31640_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__31640_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31641,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31641,(1),null);
...
var vec__31647 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31647,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31647,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__31719 = cljs.core.rest(remaining_tokens);
var G__31720 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__31719;
name_tokens = G__31720;
continue;
} else {
...
var vec__31652 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31652,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31652,(1),null);
var vec__31655 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31655,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31655,(1),null);
var vec__31658 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31658,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31658,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31658,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31658,(3),null);
...
var vec__31663 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31663,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31663,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31663,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31663,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31663,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31663,(5),null);
...
if(cljs.core.truth_(temp__5814__auto__)){
var vec__31666 = temp__5814__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31666,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31666,(1),null);
var vec__31669 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31669,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31669,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__31672 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__31672) : devtools.munging.parse_fn_info_deep.call(null,G__31672));
})()));
}
} else {
return fn_info;
...
var G__31728 = (arity + (1));
var G__31729 = (function (){var temp__5814__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5814__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__31673){
var vec__31674 = p__31673;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31674,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31674,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31677_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__31677_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31678_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__31678_SHARP_);
}),sorted_infos);
...
var args__5728__auto__ = [];
var len__5722__auto___31730 = arguments.length;
var i__5723__auto___31731 = (0);
while(true){
if((i__5723__auto___31731 < len__5722__auto___31730)){
args__5728__auto__.push((arguments[i__5723__auto___31731]));

var G__31732 = (i__5723__auto___31731 + (1));
i__5723__auto___31731 = G__31732;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__31681){
var vec__31682 = p__31681;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31682,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq31679){
var G__31680 = cljs.core.first(seq31679);
var seq31679__$1 = cljs.core.next(seq31679);
var self__5707__auto__ = this;
return self__5707__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31680,seq31679__$1);
}));
...
var map__31686 = options;
var map__31686__$1 = cljs.core.__destructure_map(map__31686);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31686__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31686__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31686__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31686__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__31687 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31687,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31687,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31687,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31687,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31687,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31687,(5),null);
...
var o__28701__auto__ = f;
return (o__28701__auto__["getBasis"]).call(o__28701__auto__);
});
/**
...
}catch (e31690){var _e__28708__auto__ = e31690;
...
var G__31734 = (obj[cljs.core.first(path)]);
var G__31735 = cljs.core.rest(path);
obj = G__31734;
path = G__31735;
continue;
} else {
...
var _STAR_ = (function (accum,p__31691){
var vec__31692 = p__31691;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31692,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31692,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__31695){
var vec__31696 = p__31695;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31696,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31696,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31696,(2),null);
...
var post_process = (function (p__31700){
var vec__31701 = p__31700;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31701,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31701,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31699_SHARP_){
return (obj[cljs.core.first(p1__31699_SHARP_)]);
}),sorted_matches);
